...
Plusieurs scénettes peuvent être supprimées / ajoutées pour s'adapter aux formats plus courts ou plus longs, selon la programmation !
...
Seront passées en revue, les situations suivantes :
